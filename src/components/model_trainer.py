...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        '''Initial model trainer function to handle data splitting, training
        and the different types of Algorithms to be used
        
        ''' 
        try:
            logging.info('split training and testing inputs data')
            ...
            '''Dictionary of the mode to be used for training'''
            ...
            '''Get the best mode from the dictionary'''
